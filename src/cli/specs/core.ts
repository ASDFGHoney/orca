...
export const CORE_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'Use --no-parent to file the new worktree at the top level instead of under the inferred parent. A child nests under its parent in the sidebar and travels with it when the user reviews, sleeps, or deletes that line of work; a top-level worktree is tracked on its own.',
