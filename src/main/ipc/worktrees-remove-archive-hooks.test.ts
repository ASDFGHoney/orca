...
vi.mock('../git/worktree-listing', async () =>
  (await import('./worktrees-test-module-mocks')).gitWorktreeListingModuleMock()
)
vi.mock('../git/worktree-removal-preflight', async () =>
  (await import('./worktrees-test-module-mocks')).gitWorktreeRemovalPreflightModuleMock()
)
vi.mock('../git/worktree-branch-cleanup', async () =>
  (await import('./worktrees-test-module-mocks')).gitWorktreeBranchCleanupModuleMock()
)
